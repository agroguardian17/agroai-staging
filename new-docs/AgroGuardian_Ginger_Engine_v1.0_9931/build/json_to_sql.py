...
INSERT INTO kb_stages VALUES
 ...
 -- Sentinel, not a lifecycle stage: rules that apply at every stage (Domain 14
 -- pipeline hooks, DPDP guards, positioning blocks) declare stage_code 'ALL'.
 -- No DAP window, so DAP->stage resolution never selects it; it exists only to
 -- satisfy the kb_rules.stage_code foreign key for those rules.
 ('ALL','all_stages','सर्व अवस्था',NULL,NULL,NULL,FALSE,NULL)
