...
from notification_policy import (ONCE_UNTIL_RESOLVED, EVENT, WINDOW, SILENT_GUARD)
...
def build_runner(source, *, state_store=None):
    ...
    import expert_override, runner as runner_mod
...
if __name__ == '__main__':
    ...
    from runner import demo_context, render_day
